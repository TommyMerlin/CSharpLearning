...
namespace DAL
{
    ...
    public class SQLHelper
    {
        ...
        public static DataSet SelectSQLReturnDataset(string sql)
        {
            SqlConnection conn = new SqlConnection(ConnStr);           //新建连接对象
        ...
        public static DataSet SelectSQLReturnDataset(string sql, SqlParameter[] pars)
        {
            SqlConnection conn = new SqlConnection(ConnStr);           //新建连接对象
            SqlDataAdapter sda = new SqlDataAdapter(sql, conn);        //新建数据适配器对象
        ...
        /// </summary>
        /// <param name="sql">SQL查询语句</param>
        public static DataTable SelectSQLReturnDataTable(string sql)
        {
            SqlConnection conn = new SqlConnection(ConnStr);           //新建连接对象
            SqlDataAdapter sda = new SqlDataAdapter(sql, conn);        //新建数据适配器对象
        ...
        /// </summary>
        /// <param name="sql">SQL查询语句</param>
        public static DataTable SelectSQLReturnDataTable(string sql, SqlParameter[] pars, CommandType type)
        {
            SqlConnection conn = new SqlConnection(ConnStr);           //新建连接对象
            SqlDataAdapter sda = new SqlDataAdapter(sql, conn);        //新建数据适配器对象
        ...
        public static SqlDataReader SelectSQLReturnReader(string sql)
        {
            try
            {
                SqlConnection conn = new SqlConnection(ConnStr);           //新建连接对象
        ...
        /// <returns>DataReader数据阅读器</returns>
        public static SqlDataReader SelectSQLReturnReader(string sql, SqlParameter[] pars)
        {
            SqlConnection conn = new SqlConnection(ConnStr);           //新建连接对象
            SqlCommand cmd = new SqlCommand(sql, conn);                //新建命令对象
